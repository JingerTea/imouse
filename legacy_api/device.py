...
class Device:
    ...
    def device_get(self, device_id: str = '') -> Optional[DeviceListResponse]:
        ...
        return self._api._call_and_parse(DeviceListResponse, self._api._payload.device_get, device_id)
    ...
    def device_group_get(self, group_id: str = '') -> Optional[GroupListResponse]:
        ...
        return self._api._call_and_parse(GroupListResponse, self._api._payload.device_group_get, group_id)
    ...
    def device_group_getdev(self, group_id: str) -> Optional[DeviceListResponse]:
        ...
        return self._api._call_and_parse(DeviceListResponse, self._api._payload.device_group_getdev, group_id)

    def device_set_name(self, device_id, name: str) -> Optional[IdListResponse]:
        return self._api._call_and_parse(IdListResponse, self._api._payload.device_set, 
    ...
    def device_del(self, device_id: str) -> Optional[IdListResponse]:
        ...
        return self._api._call_and_parse(IdListResponse, self._api._payload.device_del, device_id)
    ...
    def device_group_set(self, group_id: str, group_name: str) -> Optional[GroupListResponse]:
        ...
        return self._api._call_and_parse(GroupListResponse, self._api._payload.device_group_set, group_id, group_name)
    ...
    def device_group_del(self, group_id: str) -> Optional[IdListResponse]:
        ...
        return self._api._call_and_parse(IdListResponse, self._api._payload.device_group_del, group_id)
    ...
    def device_airplay_set(self, device_id: str, params: SetDeviceAirplayParams) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_airplay_set, device_id, params)
    ...
    def device_airplay_connect(self, device_id: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_airplay_connect, device_id)
    ...
    def device_airplay_connect_all(self) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_airplay_connect_all)
    ...
    def device_airplay_disconnect(self, device_id: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_airplay_disconnect, device_id)
    ...
    def device_restart(self, device_id: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_restart, device_id)
    ...
    def device_usb_restart(self, vpids: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.device_usb_restart, vpids)
    ...
    def device_sort_set(self, sort_index, sort_value: int) -> Optional[DeviceSortResponse]:
        ...
        return self._api._call_and_parse(DeviceSortResponse, self._api._payload.device_sort_set, sort_index, sort_value)
    ...
    def device_sort_get(self) -> Optional[DeviceSortResponse]:
        ...
        return self._api._call_and_parse(DeviceSortResponse, self._api._payload.device_sort_get)
