...
class User:
    ...
    def config_user_login(self, account_number, password: str, utag: int = 1) -> Optional[UserResponse]:
        ...
        return self._api._call_and_parse(UserResponse, self._api._payload.config_user_login, account_number, password, utag)
    ...
    def config_user_logout(self) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.config_user_logout)
    ...
    def config_user_info(self) -> Optional[UserResponse]:
        ...
        return self._api._call_and_parse(UserResponse, self._api._payload.config_user_info)
    ...
    def config_user_switch(self, utag: int) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.config_user_switch, utag)
