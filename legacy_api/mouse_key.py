...
class MouseKey:
    ...
    def mouse_click(self, device_id, button: str, x, y, time: int = 0) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_click, device_id, button, x, y, time)
    ...
    def mouse_swipe(self, device_id, params: MouseSwipeParams) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_swipe, device_id, params)
    ...
    def mouse_up(self, device_id, button: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_up, device_id, button)
    ...
    def mouse_down(self, device_id, button: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_down, device_id, button)
    ...
    def mouse_move(self, device_id: str, x, y: int) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_move, device_id, x, y)
    ...
    def mouse_reset(self, device_id: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_reset, device_id)
    ...
    def mouse_wheel(self, device_id, direction: str, len, number: int) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.mouse_wheel, device_id, direction, len, number)
    ...
    def key_sendkey(self, device_id, key, fn_key: str) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.key_sendkey, device_id, key, fn_key)
    ...
    def key_sendhid(self, device_id, command_list: List[str]) -> Optional[CommonResponse]:
        ...
        return self._api._call_and_parse(CommonResponse, self._api._payload.key_sendhid, device_id, command_list)
