...
class Shortcut(BaseAPI):
    ...
    def shortcut_album_get(self, device_id: str, album_name: str = "", num: int = 20,
        ...
        return self._call_and_parse(AlbumFileResponse, self._payload.shortcut_album_get, 
    ...
    def shortcut_album_upload(self, device_id: str, album_name: str, files: List[str], is_zip: bool = False,
        ...
        return self._call_and_parse(AlbumFileResponse, self._payload.shortcut_album_upload,
    ...
    def shortcut_album_down(self, device_id: str, files: List[AlbumFileParams], is_zip: bool = False,
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_album_down,
    ...
    def shortcut_album_del(self, device_id: str, files: List[AlbumFileParams], outtime: int = 30) -> AlbumFileResponse:
        ...
        return self._call_and_parse(AlbumFileResponse, self._payload.shortcut_album_del,
    ...
    def shortcut_album_clear(self, device_id: str, album_name: str = '', outtime: int = 30) -> AlbumFileResponse:
        ...
        return self._call_and_parse(AlbumFileResponse, self._payload.shortcut_album_clear,
    ...
    def shortcut_file_get(self, device_id: str, path: str = "",
        ...
        return self._call_and_parse(PhoneFileResponse, self._payload.shortcut_file_get,
    ...
    def shortcut_file_upload(self, device_id: str, path: str, files: List[str], is_zip: bool = False,
        ...
        return self._call_and_parse(PhoneFileResponse, self._payload.shortcut_file_upload,
    ...
    def shortcut_file_down(self, device_id: str, path: str, files: List[PhoneFileParams], is_zip: bool = False,
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_file_down,
                                   device_id, path, is_zip, files, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_file_del(self, device_id: str, path: str, files: List[PhoneFileParams],
        ...
        return self._call_and_parse(PhoneFileResponse, self._payload.shortcut_file_del,
    ...
    def shortcut_clipboard_set(self, device_id: str, text: str, sleep: int = 0, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_clipboard_set,
    ...
    def shortcut_clipboard_get(self, device_id: str, outtime: int = 10) -> ResultTextResponse:
        ...
        return self._call_and_parse(ResultTextResponse, self._payload.shortcut_clipboard_get,
    ...
    def shortcut_exec_url(self, device_id: str, url: str, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_exec_url,
    ...
    def shortcut_switch_device(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_device,
    ...
    def shortcut_switch_bril(self, device_id: str, state: float, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_bril,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_switch_torch(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_torch,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_switch_flight(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_flight,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_switch_cdpd(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_cdpd,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_switch_wlan(self, device_id: str, state: int, outtime: int = 10) -> CommonResponse:
        ...
        return self._call_and_parse(CommonResponse, self._payload.shortcut_switch_wlan,
                                   device_id, state, outtime * 1000, _timeout=outtime + 1)
    ...
    def shortcut_device_ip(self, device_id: str, outtime: int = 10) -> ResultTextResponse:
        ...
        return self._call_and_parse(ResultTextResponse, self._payload.shortcut_device_ip,
